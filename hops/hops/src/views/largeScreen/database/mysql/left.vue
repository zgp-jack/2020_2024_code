    ...
    <div class="business-left">
        ...
        <div class="large-card">
            <el-row :gutter="8" style="margin-top: 8px">
                <el-col :span="12">
                    <div class="div-info">
                        <p class="div-info-label">InnoDB缓冲池大小</p>
                        <p class="div-info-value"><span>{{ basicData.innoDBBufferPoolData }}</span>MB</p>
                    </div>
                </el-col>
                <el-col :span="12">
                    <div class="div-info">
            ...
            <el-row :gutter="8" style="margin-top: 8px">
                <el-col :span="8">
                    <div class="div-info">
                        <p class="div-info-label">当前行锁数</p>
                        <p class="div-info-value"><span>{{ basicData.innodbRowLockCurrentWaits }}</span></p>
                    </div>
                </el-col>
                <el-col :span="8">
                    <div class="div-info">
                        <p class="div-info-label">行锁平均时长</p>
                        <p class="div-info-value"><span>{{ basicData.innodbRowLockTimeAvg }}</span>秒</p>
                    </div>
                </el-col><el-col :span="8">
                    <div class="div-info">
                        <p class="div-info-label">行锁最大时长</p>
                        <p class="div-info-value"><span>{{ basicData.innodbRowLockTimeMax }}</span>秒</p>
                    </div>
                </el-col>
            </el-row>
            <el-row :gutter="8" style="margin-top: 8px">
