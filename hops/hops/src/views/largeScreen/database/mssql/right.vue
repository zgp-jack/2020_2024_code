<template>
    <div class="mssql-right">
            ...
            <LineChart domId="lineFlow" height="100%" :units="[FlowListUnit]" :legend="['上行', '下行']" :seriesData1="FlowList[0]" :seriesData2="FlowList[1]">
                <template v-slot:title>
                    <div class="line-title">
                        <span class="large-sub-label">流量</span>
        ...
        <div class="large-card" style="height: 50%;">
            <LineMultipleChart :left="46"  v-if="seriesData.length" domId="lineMemMultiple" :seriesData="seriesData" :unit="seriesDataUnit" height="100%"> </LineMultipleChart>
        </div>
