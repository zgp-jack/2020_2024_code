<template>
	<div id="rtcPlayer">
		<!-- <video id="webRtcPlayerBox" controls autoplay style="text-align: left">Your browser is too old which doesn't support HTML5 video.</video> -->
	</div>
</template>
...
export default {
	...
	props: ['videoUrl', 'elementId', 'error', 'hasaudio'],
	mounted() {
