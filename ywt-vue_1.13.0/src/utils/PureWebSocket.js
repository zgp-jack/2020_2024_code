 ...
 * @CreateTime: 2021-11-10 17:27:03
 * @LastEditors: Pure <305737824@qq.com>
 * @LastEditTime: 2023-02-13 17:20:36
...
export default class PureWebSocket {
  ...
  init() {
    ...
    this.ws.onopen = (event) => {
      this.#alive = true;
      store.state.ticketServiceDesk.socketStatus = 1;
      clearInterval(this.#reconnectTimer);
      this.healthCheck();
    };
    this.ws.onclose = (event) => {
      this.#alive = false;
      store.state.ticketServiceDesk.onlineList = 'WebSocket断开链接！';
      store.state.ticketServiceDesk.socketStatus = 2;
    ...
    this.ws.onerror = (event) => {
      ...
      store.state.ticketServiceDesk.socketStatus = 3;
    };
  }
