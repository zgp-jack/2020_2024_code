 ...
 * @CreateTime: 2022-01-04 17:56:03
 * @LastEditors: Pure <305737824@qq.com>
 * @LastEditTime: 2022-10-08 16:53:34
 * @Description:巡检模板弹窗
-->
<template>
  <div class="drawer">
...
<script>
import InspectionContentDialog from '../dialog/inspectionContent.vue';
  ...
  methods: {
    ...
    async handleEditInspectionContent(row) {
      ...
      this.$dialog({
        ...
        width: '688px',
        position: 'center',
        component: () => <InspectionContentDialog data={row} tempId={this.formData.id} onDone={this.handleAddedInspectionContent}/>,
      });
    },
    async handleInspectionContentDialog() {
      this.$dialog({
        title: '添加巡检内容',
        width: '688px',
        position: 'center',
        component: () => <InspectionContentDialog tempId={this.formData.id} onDone={this.handleAddedInspectionContent}/>,
      });
    },
    // 添加巡检内容成功后的处理
