 ...
 * @CreateTime: 2021-12-28 11:49:47
 * @LastEditors: Pure 305737824@qq.com
 * @LastEditTime: 2023-06-07 10:07:35
 * @Description:科室弹窗
-->
          ...
          <el-form-item label-width="0px" class="form-item-wrapper">
            ...
            <el-col :span="12">
              <el-form-item label="上级科室">
                <department-cascader v-model="formData.parentId" :disabled-list="disabledList" />
              </el-form-item>
            </el-col>
          </el-form-item>
          <el-form-item label-width="0px" class="form-item-wrapper">
          ...
          <el-form-item label-width="0px" class="form-item-wrapper">
            <el-col :span="12">
              <el-form-item label="院区" prop="hospital">
                <hospital-select v-model="formData.hospital" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-form-item :key="index" label-width="0px" class="form-item-wrapper">
              <el-col :span="10">
                <el-form-item
                  ...
                  :rules="{ required: false, message: '请输入联系人', trigger: 'blur' }"
                >
              ...
              <el-col :span="10">
                ...
                <el-form-item
                  ...
                  :rules="{ required: false, message: '联系电话', trigger: 'blur' }"
                >
...
import HospitalSelect from '../component/hospitalSelect';
import DepartmentCascader from '../component/departmentCascader';

import EngineerSelect from '@/feat/system/user/component/engineerSelect';
...
export default {
  ...
  data() {
    return {
      name: '科室',
      detailApi: DepartmentApi.detail,
      formData: {
        state: 1,
        contacts: [{
          user: '',
      ...
      rules: {
        ...
        deptCode: [
          ...
          { min: 1, max: 13, message: '长度不能超过13个字符', trigger: 'blur', }
        ],
      },
    };
  },
