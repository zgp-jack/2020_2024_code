 ...
 * @CreateTime: 2022-07-21 17:02:39
 * @LastEditors: Pure <305737824@qq.com>
 * @LastEditTime: 2022-07-21 17:05:40
 * @Description:没有小组的人员抽屉
-->
<template>
  <div class="drawer">
    <div class="header">
  ...
  methods: {
    ...
    dealWithDefaultSelectedData() {
      if (this.defaultSelectedData.isTeam) {
        ...
        this.radio = `engineer-${this.defaultSelectedData.engineerId}`;
      }
