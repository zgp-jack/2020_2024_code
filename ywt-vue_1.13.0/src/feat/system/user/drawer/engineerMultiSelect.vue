 ...
 * @CreateTime: 2022-07-05 16:08:55
 * @LastEditors: Pure <305737824@qq.com>
 * @LastEditTime: 2022-07-07 15:20:03
 * @Description:人员多选抽屉
-->
<template>
  <div class="drawer">
    ...
    confirm() {
      ...
      if (data.length) {
        const result = data.map((item) => {
          ...
          if (item.isTeam) {
            resultItem.teamId = item.teamId;
            resultItem.engineerId = null;
          } else {
            resultItem.teamId = item.teamId;
            resultItem.engineerId = item.engineerId;
          }
          return resultItem;
        });
