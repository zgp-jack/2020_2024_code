 ...
 * @CreateTime: 2021-12-31 19:20:55
 * @LastEditors: Pure <305737824@qq.com>
 * @LastEditTime: 2022-04-01 14:30:47
 * @Description:资产模块路由
 */
...
const PropertyRoute = {
  ...
  label: '资产',
  component: Layout,
  redirect: '/property/propertyManagement/stadingBook',
  meta: {
    title: '资产',
    icon: 'property',
    add: true,
  ...
  children: [{
    ...
    name: 'ZcZcgl',
    label: '资产管理',
    component: () => import('./propertyManagement'),
    ...
    children: [{
      ...
      name: 'ZcZcglTzgl',
      label: '台账管理',
      component: () => import('./propertyManagement/standingBook'),
      meta: {
        title: '台账管理',
      },
    }, {
