 ...
 * @LastEditTime: 2023-04-12 11:35:41
        ...
        <el-row>
          ...
          <el-col :span="50">
            <el-form-item label="制作商">
              ...
              <common-dept-cascader v-model="formData.manufacturer" class="w-100" :source="manufacturerList" />
            </el-form-item>
          </el-col>
          <el-col :span="50">
            <el-form-item label="供应商">
              <common-dept-cascader v-model="formData.supplier" class="w-100" :source="manufacturerList" />
            </el-form-item>
          </el-col>
