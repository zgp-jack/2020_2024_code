 ...
 * @LastEditTime: 2022-12-08 10:58:36
 * @Description:综合-值班管理
-->
        ...
        <el-main>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <div
                  v-for="(item,index) in selectedRow.schedulUsers"
                  :key="index"
                >
                  <template>
                ...
                <el-form-item label-width="0" style="padding-top:200px">
                  <el-row>
                    ...
                    ><el-button v-show="!selectedRow.disabled" type="primary" @click="handleUpdateDutySchedule">保存</el-button></el-col>
                  </el-row>
                </el-form-item>
          ...
          >
            ...
            >
              ...
              <div
                v-for="(item,index) in addDutyScheduleData.schedulUsers"
                :key="index"
              >
                <template>
                  <div class="hospital">{{ getHospitalNameById(item.hospital) }}</div>
...
export default {
  ...
  methods: {
    ...
    handleSettingHoliday(dayData, data) {
      ...
      if (!this.isSettingHolidy || !dayData.type.includes('current') || (moment(date) <= this.todayDate)) {
        return;
      }
    ...
    handleClickRow(row, event, dutyScheduleData) {
      ...
      this.selectedRow = Object.assign({
        disabled: moment(dutyScheduleData.holidayTime) <= this.todayDate,
      }, row);
      const currentTarget = event.currentTarget;
