...
<template>
  <el-container>
    <el-header height="auto" class="layout-panel-el-header-wrapper">
      <span class="layout-panel-el-header-wrapper--title">已调待定</span>
      <span class="layout-panel-el-header-wrapper--code">{{ CodeText }}</span>
    </el-header>
    <el-main ref="main" class="layout-panel-el-main-wrapper">
      <el-row class="layout-panel-el-main-wrapper-row">
        <el-col :span="10" class="layout-panel-el-main-wrapper-col P-R-16">
          <PreliminaryLevel ref="preliminaryLevel" />
        </el-col>
        <el-col :span="10" class="layout-panel-el-main-wrapper-col P-R-16">
          <el-row>
            <el-col :span="24">
...
export default {
  components: {
    ...
    PreliminaryLevel: () => import('../panels/preliminaryLevel.vue'),
  ...
  methods: {
    ...
    async save() {
      try {
        ...
        await this.$refs['preliminaryLevel'].save();
    ...
    async submit() {
      try {
        ...
        await this.$refs['preliminaryLevel'].submit();
