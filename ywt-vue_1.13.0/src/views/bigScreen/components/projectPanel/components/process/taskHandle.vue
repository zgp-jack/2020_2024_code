...
import Tag from '@/views/bigScreen/components/projectPanel/components/tag/index.vue';
export default {
...
<style  lang="scss">
@import "~@/views/bigScreen/style/linearGradient.scss";
...
@import "~@/views/bigScreen/style/timeLine.scss";
