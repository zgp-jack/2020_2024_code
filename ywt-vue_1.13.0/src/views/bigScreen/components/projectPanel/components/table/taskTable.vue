...
<template>
  ...
  >
    ...
    <el-table-column align="left" :show-overflow-tooltip="true" prop="file" label="附件" width="70px" min-width="70px" fixed="right">
      <template #default="{row}">
...
import IconFile from '@/views/bigScreen/components/projectPanel/components/table/iconFile.vue';
import Button from '@/views/bigScreen/components/projectPanel/components/button/index.vue';
import TaskMain from '@/views/bigScreen/components/projectPanel/components/task/main.vue';
import TaskChild from '@/views/bigScreen/components/projectPanel/components/task/child.vue';
import ProcessTimeLine from '@/views/bigScreen/components/projectPanel/components/process/taskHandle';
export default {
