...
import Drawer from '@/views/bigScreen/components/projectPanel/components/drawer/index.vue';
import TaskTable from '@/views/bigScreen/components/projectPanel/components/table/projectTask.vue';
export default {
  name: 'ProjectInfo',
  components: {
    DicSelect,
  ...
  computed: {
    ...
    JoinUsers() {
      ...
      taskJoinUsers = taskJoinUsers.join(',').split(',');
