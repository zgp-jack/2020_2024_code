...
import EngineerInfoDrawer from '@/views/system/user/drawer/engineer.vue';
import EngineerApi from '@/apis/system/engineer';
import PaginationTable from '@/minxins/common/paginationTable';
import DepartmentTree from '@/feat/system/department/component/departmentTree.vue';
export default {
  name: 'XtszYhgl',
  components: {
    DepartmentTree,
  ...
  methods: {
    ...
    onUpdateEngineer(row) {
      this.$drawer({
        width: '1688px',
        component: () => <EngineerInfoDrawer data={row} onDone={this.fetchData} operatorType='UPDATE'/>,
      });
    },
