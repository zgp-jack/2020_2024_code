 ...
 * @CreateTime: 2021-12-14 16:16:48
 * @LastEditors: Pure <305737824@qq.com>
 * @LastEditTime: 2021-12-16 13:06:31
 * @Description:树形字典
-->
...
import CategoryDialog from '@/views/system/dictionary/tree/dialog/category.vue';
import CategoryItemDialog from '@/views/system/dictionary/tree/dialog/item.vue';
export default {
  name: 'XtszZdwhSxzd',
